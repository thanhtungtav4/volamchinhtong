        ...
        <div class="wrap-iframe">
            <div id="iframe-id">
                <div class="form form-min pd-b-50">
                    <form method="post" id="restPassForm" onsubmit="handleSubmitRestPassword(event)">
                        <h2>Đổi Mật Khẩu</h2>
                        ...
                        <div class="form-group">
                            <label for="password1_confirmation">Xác Nhận Mật khẩu *</label>
                        ...
                        <div class="form-group form-group-submit">
                            <button class="btn btn-primary" type="submit" name="submit">Đặt Lại Mật Khẩu</button>
                        </div>
                    </form>
                </div>
            </div>
