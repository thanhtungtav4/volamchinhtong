                ...
                <div class="mt-2 flex w-full border-b-2 border-gray-100">
                    ...
                    <div class="w-7/12">
                         <span class="relative z-0 inline-flex shadow-sm rounded-md float-right">
                              <button for="kc-us-7-days" type="button" class="relative inline-flex items-center px-4 py-2 rounded-l-md border border-gray-300 bg-white text-sm font-medium text-gray-700 hover:bg-green-100 focus:z-10 focus:outline-none focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 <?php if ( 'today' === $time_filter ) {
                                 echo "bg-green-100 hover:bg-green-100";
                              } ?>">
                                <a href="<?php echo $today_url; ?>" id="kc-us-7-days" class="text-black hover:text-black"><?php _e( 'Today', 'url-shortify' ); ?></a>
                              </button>
                               <button type="button" class="-ml-px relative inline-flex items-center px-4 py-2 border border-gray-300 bg-white text-sm font-medium text-gray-700 hover:bg-green-100 focus:z-10 focus:outline-none focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 <?php if ( 'last_7_days' === $time_filter ) {
	                               echo "bg-green-100 hover:bg-green-100";
                               } ?>">
