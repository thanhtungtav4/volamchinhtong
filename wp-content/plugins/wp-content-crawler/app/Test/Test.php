...
use WPCCrawler\Test\Tests\OpenAiGptShortCodeTest;
...
class Test {
    ...
    /** @var string */
    public static $TEST_TYPE_OPENAI_GPT_SHORT_CODE              = 'test_type_openai_gpt_short_code';
    ...
    public static function respondToTestRequest($data): ?string {
        $tests = [
            ...
            static::$TEST_TYPE_OPENAI_GPT_SHORT_CODE                => OpenAiGptShortCodeTest::class,
        ];
