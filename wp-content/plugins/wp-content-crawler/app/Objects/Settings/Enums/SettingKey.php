...
class SettingKey {
    ...
    const WPCC_TRANSLATION_DEEPL_TRANSLATE_FROM                     = '_wpcc_translation_deepl_translate_from';                      // string   Language of the original content for DeepL Translate
    const WPCC_TRANSLATION_DEEPL_TRANSLATE_TO                       = '_wpcc_translation_deepl_translate_to';                        // string   Target language for DeepL Translate
    const WPCC_TRANSLATION_DEEPL_TRANSLATE_API_KEY                  = '_wpcc_translation_deepl_translate_api_key';                   // string   API key retrieved from DeepL Translate
    const WPCC_TRANSLATION_DEEPL_TRANSLATE_FORMALITY                = '_wpcc_translation_deepl_translate_formality';                 // string   Value of the "Formality" option of DeepL
    const WPCC_TRANSLATION_DEEPL_TRANSLATE_TEST                     = '_wpcc_translation_deepl_translate_test';                      // string   Text for testing DeepL Translate API
...
//    const WPCC_SPINNING_CHIMP_REWRITER_TEST                         = '_wpcc_spinning_chimp_rewriter_test';                           // string   Text for testing Chimp Rewriter
    ...
    // APIs
    const WPCC_API_OPENAI_SECRET_KEY                                = '_wpcc_api_openai_secret_key';      // string   Secret key retrieved from OpenAI
    const WPCC_API_OPENAI_SECRET_KEY_TEST                           = '_wpcc_api_openai_secret_key_test'; // string   This does not store any value. This is a placeholder setting key.
    ...
    const WPCC_DISABLE_SAVING_SECTION_STATES                        = '_wpcc_disable_saving_section_states';       // bool     True if expansion state of the sections should be saved. Otherwise, false.
    const WPCC_DISABLE_DEFAULT_SITE_SECTION_STATES                  = '_wpcc_disable_default_site_section_states'; // bool     True if the default section states must not be used for new sites.
