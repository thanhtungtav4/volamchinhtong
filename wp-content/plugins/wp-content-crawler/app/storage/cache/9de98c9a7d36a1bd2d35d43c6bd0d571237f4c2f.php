<div class="input-group find-replace-in-custom-short-code <?php echo e(isset($addon) ? 'addon' : ''); ?> <?php echo e(isset($remove) ? 'remove' : ''); ?>"
    ...
    <?php endif; ?>
</div><?php /**PATH D:\xampp\htdocs\docker-dental\wp_data\wp-content\plugins\wp-content-crawler\app\views/form-items/find-replace-in-custom-short-code.blade.php ENDPATH**/ ?>